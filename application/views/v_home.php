...
<html class="no-js">
	...
	<aside id="fh5co-hero" class="js-fullheight">
		<div class="flexslider js-fullheight">
			<ul class="slides">
		   	<li style="background-image: url('https://scontent-sea1-1.cdninstagram.com/vp/40aaab7e275f22c8f8c74cc9800b84e4/5C257149/t51.2885-15/e35/11849879_1691089224457227_1803949246_n.jpg');">
		   		<div class="overlay-gradient"></div>
		   		<div class="container">
		   			<div class="col-md-10 col-md-offset-1 text-center js-fullheight slider-text">
		   				<div class="slider-text-inner">
		   					<h2>Selamat Datang Di Desa Ngabab</h2>
		   					<!-- <p><a href="#" class="btn btn-primary btn-lg">Get started</a></p> -->
		   				</div>
		   			</div>
		   		</div>
		   	</li>
		   	<li style="background-image: url('https://desangabab.files.wordpress.com/2008/08/cimg0061.jpg');">
		   		<div class="container">
		   			<div class="col-md-10 col-md-offset-1 text-center js-fullheight slider-text">
		   				<div class="slider-text-inner">
		   					<h2>Selamat Datang Di Desa Ngabab</h2>
		   	...
		   	<li style="background-image: url('https://desangabab.files.wordpress.com/2008/08/cimg0065.jpg');">
		   		<div class="container">
		   			<div class="col-md-10 col-md-offset-1 text-center js-fullheight slider-text">
		   				<div class="slider-text-inner">
		   					<h2>Selamat Datang Di Desa Ngabab</h2>
	...
	<div class="fh5co-section-with-image">
		...
		<img src="https://desangabab.files.wordpress.com/2008/08/cimg0065.jpg" alt="" class="img-responsive">
		<div class="fh5co-box animate-box">
			<h2>Desa Ngabab</h2>
			<p>Kecamatan Pujon, Kabupaten Malang</p>
